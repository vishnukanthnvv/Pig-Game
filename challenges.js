...
3. Add another dice to the game, so that there are 2 dices now. the player looses his current score when one of them is a 1. (You will need css to position the second dice, so take a look at the css code)
*/
...
document.querySelector('.btn-hold').addEventListener('click', function() {
    ...
    if (scores[activePlayer] >= winTarget) {
